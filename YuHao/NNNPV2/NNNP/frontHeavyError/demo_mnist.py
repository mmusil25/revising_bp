...
data_train = pd.read_csv('./mnist_test.csv')
...
mlp_lc = MLP(dims=[input_dim, 400, 200, 100, 80, 40, 10], batch_size=batch_size)
mlp_base = MLP(dims=[input_dim, 400, 200, 100, 80, 40, 10], batch_size=batch_size)
