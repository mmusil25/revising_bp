...
def main(args, test_args):
    ...
    if args.direct_run:
        ...
        with open('mlp_test'+platform_extension[args.platform], 'w') as script:
            for cmd in cmds:
                script.write(cmd+'\n')
...
if __name__ == '__main__':
    ...
    parser.add_argument('--platform', dest='platform', help='Choose the format of batch file',
                        default='windows', choices=list(platform_extension.keys()))
